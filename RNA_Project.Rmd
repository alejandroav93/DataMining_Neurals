...
Se hace el set de una semilla para evitar los efectos del "RNG" y garantizar los mismos resultados. Se importan los datos para la creacion de sets de entrenamiento para el algoritmo
```{r training set}
set.seed(123)
